...
Feature: Retail Application Account Feature
  ...
  Scenario: Verify user can update profile information
    ...
    And User update Name 'shakokoo' and Phone '8756986556'
  ...
  Scenario: Verify User can Update password
    ...
    And a messege should be displayed2 'Password Updated Successfully’
    And User enter below information again
      | previousPassword | newPassword | confirmPassword |
      | SHAkoko120@      | SHAkoko12@  | SHAkoko12@      |
  ...
  Scenario: Verify User can add a payment method
    ...
    And User fill Debit or credit card information
      ...
      | 4765432876543560 | gul        |               9 |           2026 |          778 |
